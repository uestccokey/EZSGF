...
import cn.ezandroid.sgf.tokens.BlackRankToken;
import cn.ezandroid.sgf.tokens.BlackStonesLeftToken;
import cn.ezandroid.sgf.tokens.BlackTeamToken;
import cn.ezandroid.sgf.tokens.BlackTimeToken;
import cn.ezandroid.sgf.tokens.CharsetToken;
import cn.ezandroid.sgf.tokens.CircleToken;
import cn.ezandroid.sgf.tokens.CommentToken;
import cn.ezandroid.sgf.tokens.DateToken;
import cn.ezandroid.sgf.tokens.DimToken;
import cn.ezandroid.sgf.tokens.EventToken;
...
import cn.ezandroid.sgf.tokens.KoToken;
import cn.ezandroid.sgf.tokens.KomiToken;
import cn.ezandroid.sgf.tokens.LabelToken;
import cn.ezandroid.sgf.tokens.LineToken;
import cn.ezandroid.sgf.tokens.MarkToken;
import cn.ezandroid.sgf.tokens.MoveNumberToken;
import cn.ezandroid.sgf.tokens.NodeNameToken;
import cn.ezandroid.sgf.tokens.PlaceToken;
import cn.ezandroid.sgf.tokens.ResultToken;
import cn.ezandroid.sgf.tokens.RoundToken;
import cn.ezandroid.sgf.tokens.RuleToken;
import cn.ezandroid.sgf.tokens.SGFToken;
import cn.ezandroid.sgf.tokens.SelectedToken;
import cn.ezandroid.sgf.tokens.SizeToken;
import cn.ezandroid.sgf.tokens.SourceToken;
import cn.ezandroid.sgf.tokens.SquareToken;
import cn.ezandroid.sgf.tokens.TextToken;
import cn.ezandroid.sgf.tokens.TimeLimitToken;
import cn.ezandroid.sgf.tokens.UserToken;
import cn.ezandroid.sgf.tokens.WhiteMoveToken;
import cn.ezandroid.sgf.tokens.WhiteNameToken;
import cn.ezandroid.sgf.tokens.WhiteRankToken;
import cn.ezandroid.sgf.tokens.WhiteStonesLeftToken;
import cn.ezandroid.sgf.tokens.WhiteTeamToken;
import cn.ezandroid.sgf.tokens.WhiteTimeToken;
